	...
	if game:GetService("CoreGui"):FindFirstChild('ColourFul Hub') then
		game:GetService("CoreGui"):FindFirstChild('ColourFul Hub'):Destroy()
	end
	...
	local ClosureBindings = {
		...
		[48] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(48)return {
			Name = "Amethyst",
			Accent = Color3.fromRGB(201, 101, 255),

			AcrylicMain = Color3.fromRGB(20, 20, 20),
			AcrylicBorder = Color3.fromRGB(110, 90, 130),
			AcrylicGradient = ColorSequence.new(Color3.fromRGB(255, 34, 97), Color3.fromRGB(131, 131, 131)),
			AcrylicNoise = 0.92,
