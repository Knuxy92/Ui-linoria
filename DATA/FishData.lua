...
FishData = {
	...
	["Deep-sea Hatchetfish"] = {
		...
		Seasons = {"None"};
		Weather = {"None"};
		Quips = {"Ooh, a Deep Sea Htchetfish!"};
	...
	["Spider Crab"] = {
		...
		Rarity = "Rare";
		Resilience = 60;
		Description = "A large, eerie crab with long, spindly legs and a tough, armored shell.";
		Hint = "Crawls along the ocean floor near submerged ruins.";
		FavouriteBait = "Deep Coral";
		FavouriteTime = "Day";
		Price = 550;
		XP = 135;
	...
	Nautilus = {
		...
		Rarity = "Legendary";
		Resilience = 60;
		Description = "An ancient, spiral-shelled mollusk with a glowing & graceful body, tentacle-filled movements.";
	...
	["Small Spine Chimera"] = {
		...
		Rarity = "Legendary";
		Resilience = 35;
		Description = "A large, intimidating fish with spiny fins, sharp teeth, and a menacing, serpent-like body.";
	...
	["Ancient Eel"] = {
		...
		Rarity = "Legendary";
		Resilience = 25;
		Description = "A long, snake-like eel with glowing patterns and a menacing, ancient presence.";
	...
	["Mutated Shark"] = {
		...
		Rarity = "Mythical";
		Resilience = 20;
		Description = "A massive, mutated shark with glowing scars, extra fins, and an unsettling, aggressive nature.";
	...
	["Barreleye Fish"] = {
		...
		Rarity = "Mythical";
		Resilience = 50;
		Description = "A transparent fish with a dome-shaped head and large, upward-facing eyes, adapted for deep waters.";
	...
	["Ancient Depth Serpent"] = {
		...
		Rarity = "Event";
		Resilience = 2;
		Description = "A colossal, serpent-like creature with armored scales and glowing eyes, lurking in the abyss.";
